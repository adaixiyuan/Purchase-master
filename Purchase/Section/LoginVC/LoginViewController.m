...
- (AutoScrollView *)bgScrollView
{
    if (_bgScrollView == nil) {
        ...
        _accountText.placeholder = NSInternationalString(@"请输入您的账号", @"请输入您的账号");
        ...
        _passwordText.placeholder = NSInternationalString(@"请输入您的密码", @"请输入您的密码");
        ...
        [_rememberBtn setTitle:NSInternationalString(@"记住密码", @"记住密码") forState:UIControlStateNormal];
        ...
        [_sureLoginBtn setTitle:NSInternationalString(@"登录", @"登录") forState:UIControlStateNormal];
